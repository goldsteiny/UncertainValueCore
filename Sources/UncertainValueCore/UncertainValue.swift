...
public struct UncertainValue: Hashable, Sendable, Codable, CommutativeAlgebraWithZero, SignedRaisable, SignMagnitudeProviding, AbsoluteErrorProviding, BoundsProviding, BoundedValuesProviding {
